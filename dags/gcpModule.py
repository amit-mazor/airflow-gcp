...
def transformFromGCS(csv_name: str, folder_name: str, project: str='airflow-gcp', credentials_path: str=None,
                   bucket_name="airflow-gcp-bucket", **kwargs):
...
with dag:
    ...
    transform_task = PythonOperator(
        ...
        op_kwargs={'csv_name': 'example_2_airflow', 'folder_name': 'airflow', 'credentials_path': '/usr/local/airflow/dags/gcpLicense.json'},
    )
