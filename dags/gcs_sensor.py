...
with dag:
    delete_task = PythonOperator(
        ...
        op_kwargs={'bucket_name': 'airflow-gcp-bucket', 'blob_name': 'airflow/example_airflow.csv', 'project': 'airflow-gcp', 'credentials_path': '/usr/local/airflow/dags/gcpLicense.json'},
    )

    checkFileSensor = gcs_sensor.GoogleCloudStorageObjectSensor(
        task_id='gcs_sensor_example1',
        bucket='airflow-gcp-bucket',
